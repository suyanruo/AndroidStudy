...
/**
 * link: https://github.com/GodisGod/studydemo
 */
public class ScrollViewPagerActivity extends AppCompatActivity {
  ...
  private ViewpagerOneFragment fragmentOne;
  private ViewPagerTwoFragment fragmentTwo;
  ...
  private void initData() {
    ...
    fragmentOne = new ViewpagerOneFragment();
    fragmentTwo = new ViewPagerTwoFragment();
